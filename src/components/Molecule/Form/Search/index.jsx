...
import { Button, Input } from "src/components/Atom";
...
const FormSearch = ({
  ...
  return (
    <div className="relative space-y-2 max-w-[270px]">
      ...
      <div
        className={`flex flex-col gap-2 rounded-md bg-black/60 text-white p-2 w-full ${
          ...
          data.slice(0, 4).map((data) => (
            ...
            >
              ...
              <div className="w-[80%]">
                ...
                <p className="line-clamp-2 text-xs italic text-neutral-400 font-medium">
                  {data.overview}
                </p>
              </div>
            </Link>
